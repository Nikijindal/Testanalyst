...
namespace PracticeCode1.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TMFeature", "As TurnUp Portal admin \r\nI would like to create,edit and delete time and material" +
                    " records\r\nso that I can manage employee record successfully", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 17
 testRunner.And(string.Format("I update \'{0}\',\'{1}\',\'{2}\' on existing time and material record", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
